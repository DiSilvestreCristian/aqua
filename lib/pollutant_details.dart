...
class _PollutantDetailsState extends State<PollutantDetails> {
  ...
  double getPercentageMedia (int month){
    ...
    switch(widget.inquinante){
      case ostreopsisName: theshold = ostreopsisEmergencyTheshold;
      break;
      case escherichiaName: theshold = escherichiaTheshold;
      break;
      case enterococcusName: theshold = enterococcusTheshold;
      break;
    }
  ...
  void initState() {
    ...
    ServicesStorico.getStorico().then((storico) {
      setState(() {
        ...
        for (Rilevazione elem in storico){
          if (elem.data.month != currentMonth && elem.data.month != secondMonth){
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    LinearPercentIndicator(
                                      percent: getPercentageMedia(currentMonth).toDouble(),
                                      animation: false,
                                      backgroundColor: colorLinearProgressBarBackground,
                                    ...
                                    LinearPercentIndicator(
                                      percent: getPercentageMedia(secondMonth).toDouble(),
                                      animation: false,
                                      backgroundColor: colorLinearProgressBarBackground,
                                      progressColor: colorPollutant,
                                      lineHeight: 25,
                                    ...
                                    LinearPercentIndicator(
                                      percent: getPercentageMedia(thirdMonth).toDouble(),
                                      animation: false,
                                      backgroundColor: colorLinearProgressBarBackground,
                                      progressColor: colorPollutant,
                                      lineHeight: 25,
